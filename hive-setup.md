...
This assumes that you will be running the rwe_bridge on the mining computer. I've provided 2 template flight sheets that can be imported to jumpstart the config process 
...
Last step, you just need to edit the custom miner section with the address of the rustweave node you're mining to. This needs the full ip/port so it'll look similar to `192.168.0.12:11110` save the changes after you're finished
...
Ideally you'd run the bridge on the same machine that your rustweaved node is running on. You can follow any of the installation methods defined in the main readme of the repo.
